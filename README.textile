...
I've swapped out what appears to be Proxima Nova from typekit for PT Sans from Google Web Fonts. The original theme didn't include although the Pea.rs website does so, I'v added a font which is similar.
